package cn.mmdata.plugin.websocketInstantMsg;
...
import cn.mmdata.plugin.websocketInstantMsg.ChatServer;
import cn.mmdata.plugin.websocketInstantMsg.ChatServerPool;
...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("FHadminqq88508650")){
			this.userjoin(message.replaceFirst("FHadminqq88508650", ""),conn);
		}if(null != message && message.startsWith("LeaveFHadminqq88508650")){
			this.userLeave(conn);
