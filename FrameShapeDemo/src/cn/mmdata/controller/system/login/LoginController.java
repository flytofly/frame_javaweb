package cn.mmdata.controller.system.login;
...
import cn.mmdata.entity.system.Role;
import cn.mmdata.entity.system.User;
...
import cn.mmdata.util.DateUtil;
import cn.mmdata.util.PageData;
import cn.mmdata.util.RightsHelper;
...
public class LoginController extends BaseController {
	...
	public Object login()throws Exception{
		...
		pd = this.getPageData();
		String errInfo = "";
		String KEYDATA[] = pd.getString("KEYDATA").replaceAll("!@#", "").replaceAll("!@#", "").split(",mm,");
	...
	public static void main(String args[]){
		System.out.println(new SimpleHash("SHA-1", "fushide", "1").toString());
	}
}
