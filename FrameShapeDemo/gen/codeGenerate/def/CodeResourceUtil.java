...
{
  private static final ResourceBundle bundle = ResourceBundle.getBundle("ftl/cengle_database");
  private static final ResourceBundle bundlePath = ResourceBundle.getBundle("ftl/cengle_config");

  public static String DIVER_NAME = "com.mysql.jdbc.Driver";

  public static String URL = "jdbc:mysql://localhost:3306/mmdata?useUnicode=true&characterEncoding=UTF-8";

  public static String USERNAME = "root";

  public static String PASSWORD = "mysql";

  public static String DATABASE_NAME = "mmdata";
  ...
  public static String resources_root_package = "resources";
 ...
 // public static String page_package = "page";
  ...
  static
  {
    ...
    resources_root_package = resources_root_package.replace(".", "/");
  }
